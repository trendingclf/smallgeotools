  ...
  return (
    <div className="space-y-10 py-10">
      ...
      <div className="grid md:grid-cols-3 gap-6 mt-12">
        {/* Core Tool 1 */}
        <a href="/tools/visibility-checker" className="block p-6 bg-blue-50 border rounded-xl shadow-sm hover:shadow-md transition border-blue-200">
        ...
        {/* Core Tool 2 */}
        <a href="/tools/schema-generator" className="block p-6 bg-blue-50 border rounded-xl shadow-sm hover:shadow-md transition border-blue-200">
